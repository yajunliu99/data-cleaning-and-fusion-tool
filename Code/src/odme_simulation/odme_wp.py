...
class DTALiteRunnerWP:
    ...
    def prepare_input_files(self):
        ...
        populated_od_src = os.path.join(self.output_folder, "odme_simulation", "od_matrix_wp", "fused_od_volume_08_Weekday_wp.csv")
    ...
    def run_assignment(self):
        ...
        if self.stop_event and self.stop_event.is_set():
            print("Stopping before DTALite ODME execution.")
            return
...
if __name__ == "__main__":
    ...
    odem_runner_wp = DTALiteRunnerWP(DEFAULT_INPUT_FOLDER, DEFAULT_OUTPUT_FOLDER)
    odem_runner_wp.run()
